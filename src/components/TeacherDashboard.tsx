          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/10 pb-6">
            <div>
              <div className="flex items-center gap-2 text-emerald-300 text-xs font-semibold tracking-wide uppercase">
                ...
                <span>Không gian lớp học số THPT</span>
              </div>
              ...
              <p className="text-slate-300 text-sm mt-1 max-w-2xl">
                Hôm nay cô muốn thực hiện hoạt động giảng dạy nào cho các lớp học?
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mt-6">
            ...
            >
              ...
              <div>
                ...
                <div className="text-[11px] text-emerald-100 mt-0.5">Sinh link & mã QR nộp bài</div>
              </div>
            </button>
