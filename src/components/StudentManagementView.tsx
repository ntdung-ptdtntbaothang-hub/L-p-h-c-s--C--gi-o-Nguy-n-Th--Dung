      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center flex-wrap gap-2.5">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold transition-all shadow-md cursor-pointer hover:shadow-lg"
            ...
            <form onSubmit={handleSaveStudentForm} className="space-y-3 text-xs">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="VD: Lớp trưởng, học sinh giỏi môn Sinh"
