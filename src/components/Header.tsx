...
import { Bell, Search, GraduationCap, Smartphone, ShieldCheck, Download, Upload, RotateCcw, Check, Sparkles } from 'lucide-react';
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500 hidden sm:block">
                    Hệ thống giao nhiệm vụ & trò chơi tương tác THPT
                  </p>
                </div>
              </div>
            </button>
